...
class Hunter2MazeEnv(hunter2_env.Hunter2Env):
    def __init__(self):
        ...
        number_actions = rospy.get_param('/hunter2/n_actions')
        ...
        self.min_range = rospy.get_param('/hunter2/min_range')
        self.max_laser_value = rospy.get_param('/hunter2/max_laser_value')
        self.min_laser_value = rospy.get_param('/hunter2/min_laser_value')
        
        # Here we will add any init functions prior to starting the MyRobotEnv
        super(Hunter2MazeEnv, self).__init__()
        ...
        self.laser_filtered_pub = rospy.Publisher('/hunter2/laser/scan_filtered', LaserScan, queue_size=1)
